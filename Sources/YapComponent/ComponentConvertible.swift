...
func convertComponent(_ component: Component) -> ComponentConvertible? {
    ...
    case AngularGradientConvertible.componentName: AngularGradientConvertible(component)
    ...
    case EllipticalGradientConvertible.componentName: EllipticalGradientConvertible(component)
    ...
    case MapViewConvertible.componentName: MapViewConvertible(component)
    ...
    case Model3DConvertible.componentName: Model3DConvertible(component)
    ...
    case UnevenRoundedRectangleConvertible.componentName: UnevenRoundedRectangleConvertible(component)
